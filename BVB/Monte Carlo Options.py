...
rf = 0.025         #research
k = 11            #should be asked for
t = 0.082               #also asked for

symbol = 'VIV.PA'
data = pd.DataFrame()
data[symbol] = wb.DataReader(symbol, data_source = 'yahoo', start = '2010-1-1')['Adj Close']
...
print('The annualized volatility is : ' + str(stdev))
